            ...
            <div class="flex">
                ...
                <div class="flex shrink-0 items-center">
                    <a href="{{ Auth::user()->isAdmin ? route('admin.dashboard') : route('home') }}">
                        <img src="{{ asset('images/logo.png') }}" alt="Logo MCB" class="h-10 w-auto">
                    </a>
                </div>
                <!-- Navigation Links -->
                <div class="hidden space-x-2 sm:-my-px sm:ms-6 sm:flex md:ms-10 md:space-x-5 lg:space-x-8">
                    @if (Auth::user()->isAdmin)
                        ...
                        <x-nav-link class="hidden md:inline-flex" href="{{ route('admin.leave-requests') }}"
                        ...
                        <x-nav-dropdown :active="request()->routeIs('admin.masters.*')" triggerClasses="text-nowrap">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link class="md:hidden" href="{{ route('admin.leave-requests') }}"
                                    :active="request()->routeIs('admin.leave-requests')">
                                    {{ __('Leave Request') }}
                                </x-dropdown-link>
